	...
	public void run(){  
		...
		while(Repository.onlineDataFlag[serviceId]){
			...
			if(queryTimeList.isEmpty()){
				...
				//data.setQueryTime999th(dataFormats.subFloat(temp[1],2));//99.9th
				...
				//data.setQueryTime90th(dataFormats.subFloat(dataFormats.percentile(queryTimeList,0.90f),2));//90th
			}
